...
class Department2 {
  public name: string;
  private employees: string[]; // only accessble inside class (or where they are defined)
...
class Department4 {
  public name: string;
  protected employees: string[]; // protected (property/method) is only accessible inside the class and subclass itself
  private readonly id: string;
